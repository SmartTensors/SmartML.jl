...
function ui_smarttensors(smarttensors_model::DataModel)
	...
	Stipple.page(smarttensors_model, class="container", title="SmartTensors", head_content="<link rel=\"icon\"  type=\"image/x-icon\" href=\"https://envitrace.com/logo/favicons/favicon.ico\"/>",
		...
		[
			StippleUI.heading("EnviTrace LLC"; img=Stipple.img(src="https://envitrace.com/logo/envitrace.png", style="width:100px;height:100px;vertical-align:middle;margin-right:10px;"))
			Stipple.row([
            ...
            Stipple.row([
                Stipple.cell(class="st-module", [
					Stipple.img(src="https://raw.githubusercontent.com/SmartTensors/SmartML.jl/main/gui-results/cr_bss_analysis_20160324/locations-3-remappped-sorted-dendrogram.png", style="width:800px;height:800px;vertical-align:middle;margin-right:10px;")
				])
			])
		]
	)
